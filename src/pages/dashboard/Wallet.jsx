                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {[10, 25, 50, 100, 200, 500].map((amount) => (
                        <button
                          ...
                          className="px-3 py-2 glass rounded-lg text-white hover:bg-white/10 transition-colors"
                        >
                          ${amount}
                        </button>
                      ))}
                    ...
                    <div className="space-y-2">
                      {paymentMethods.map((method) => (
                        <button
                          ...
                          className={`w-full p-3 rounded-lg flex items-center space-x-3 transition-all duration-300 ${
              ...
              {paymentMethods.map((method) => (
                <div key={method.id} className="tech-card p-6">
                  ...
                  <div className="flex space-x-2">
                    <button className="flex-1 px-4 py-2 bg-gradient-to-r from-neon-blue to-neon-purple text-white rounded-lg font-semibold hover:shadow-neon transition-all duration-300">
                      Cài đặt
                    </button>
