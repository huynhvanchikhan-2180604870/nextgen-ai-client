...
import SpaceProjectCard from "../components/ui/SpaceProjectCard.jsx";
import { useFeaturedProjects } from "../hooks/useProjects.js";
    ...
    <div className="min-h-screen tech-universe-bg">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold font-display neon-text mb-6">
              Build • Buy • Imagine
            </h2>
